...
var pLesson = document.getElementsByName("#consoleText");
var preLesson = document.getElementsByTagName('pre').getElementsByName("#consoleText");
var codeLesson = document.getElementsByTagName('code');
